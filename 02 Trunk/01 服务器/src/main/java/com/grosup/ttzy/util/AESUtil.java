...
public class AESUtil {
	private static final String PASSWD="Grosup";
	/**
	 * 获取解密后的字符串
	 * 
	 * @param content
	...
	{
		System.out.println(AESUtil.GetAESCode("quote@985698"));
		System.out.println(AESUtil.RevertAESCode("A0C84DD7C4CD56E5D895CB194A0F175A26BD8C2F"));
	}
}
