...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__fetch__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__tool__ = __webpack_require__(94);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_422a6e5a_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_card_vue__ = __webpack_require__(129);
var disposed = false
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__config_api__ = __webpack_require__(52);
...
function $http(queryObj) {
	...
	wx.request({
		url: __WEBPACK_IMPORTED_MODULE_3__config_api__["b" /* BASE_URL */] + queryObj.url, //必传参数
		data: queryObj.data || "", //默认为空
		header: __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_assign___default()({}, {
		...
		success: function success(res) {
			...
			if (__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_typeof___default()(res.data) != undefined) {
				if (res.data[0]) {
					...
					if (__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_typeof___default()(res.code) != undefined && res.code === 1) {
						// 请求正常
						queryObj.success && queryObj.success(res); // 默认为空函数
					} else {
						// 415 405 401
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise__ = __webpack_require__(96);
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-422a6e5a", esExports)
  }
}
