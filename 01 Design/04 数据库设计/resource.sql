...
-- ----------------------------*/
INSERT INTO `resource_def` VALUES ('1', 'RESOURCE_DEF示例表ID', 'RESOURCE_DETAILpicture2', '示例表名', '示例表注释', '预留1', '预留2', '预留3', '预留4', '预留5');
...
INSERT INTO `resource_detail` VALUES ('11', 'RESOURCE_DETAIL示例值ID3', 'RESOURCE_ATTR示例表头ID3', 'RESOURCE_DEF示例表ID', '示例表头3', '0', 'picture', '/rs/file/getfile.do?filekey=RESOURCE_DETAILpicture1', 'ApprovalAdd', '', '系统添加', '', '预留1', '预留2', '预留3', '预留4', '预留5');
...
INSERT INTO `resource_detail` VALUES ('16', 'RESOURCE_DETAIL示例值ID4', 'RESOURCE_ATTR示例表头ID4', 'RESOURCE_DEF示例表ID', '示例表头4', '2', 'picture', '/rs/file/getfile.do?filekey=RESOURCE_DETAILpicture1', 'ApprovalDel', '', '系统添加', '', '预留1', '预留2', '预留3', '预留4', '预留5');
INSERT INTO `resource_detail` VALUES ('17', 'RESOURCE_DETAIL示例值ID5', 'RESOURCE_ATTR示例表头ID1', 'RESOURCE_DEF示例表ID', '示例表头1', '0', 'picture', '/rs/file/getfile.do?filekey=RESOURCE_DETAILpicture1', 'ApprovalUpdate', '', '系统添加', '', '预留1', '预留2', '预留3', '预留4', '预留5');
