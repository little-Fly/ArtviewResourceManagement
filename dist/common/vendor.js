...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__fetch__ = __webpack_require__(57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__tool__ = __webpack_require__(68);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_mpvue_loader_lib_selector_type_script_index_0_card_vue__ = __webpack_require__(112);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_422a6e5a_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_card_vue__ = __webpack_require__(113);
var disposed = false
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_422a6e5a_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_card_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-422a6e5a", Component.options)
  } else {
    hotAPI.reload("data-v-422a6e5a", Component.options)
  }
...
// 开发环境的API前缀
var API_BASE_URL = 'https://www.hwyst.net/ttzy';
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__config_api__ = __webpack_require__(38);
...
function $http(queryObj) {
	...
	// 拿自定义登录态
	var customSession = this.$store.state.third_session;
	var customSessionObj = customSession ? { third_session: customSession } : {};
	wx.request({
		url: __WEBPACK_IMPORTED_MODULE_2__config_api__["b" /* BASE_URL */] + queryObj.url, //必传参数
		data: queryObj.data || "", //默认为空
		header: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()({}, {
		...
		success: function success(res) {
			var resData = '';
			if (res.data.length > 0) resData = res.data[0];else resData = res.data;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise__ = __webpack_require__(70);
...
function checkUserInfoAuth() {
  return new __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
    ...
    wx.getSetting({
      success: function success(res) {
        console.log('\u7528\u6237\u6388\u6743\u4FE1\u606F' + __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(res));
...
var $tool = {
  ...
  getRoleNameByRoleKey: getRoleNameByRoleKey,
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-422a6e5a", esExports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__listToStyles__ = __webpack_require__(219);
/*
  MIT License http://www.opensource.org/licenses/mit-license.php
  Author Tobias Koppers @sokra
  Modified by Evan You @yyx990803
